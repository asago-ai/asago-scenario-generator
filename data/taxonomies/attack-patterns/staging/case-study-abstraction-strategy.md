...
Transforming a concrete ATLAS case study into a asago-scenario-generator abstract attack
...
**Add** (supply asago-scenario-generator-specific fields):
...
| CS0056 | Large-scale model distillation/IP theft | None | **OUT OF SCOPE** -- Model distillation is an attack on the AI service provider, not on an agentic system. Does not fit asago-scenario-generator's threat model (agentic AI threats). |
...
AP-T2-07  asago-scenario-generator  skos:relatedMatch  AML.T0051.001  mitre-atlas  semapv:ManualMappingCuration
AP-T2-07  asago-scenario-generator  skos:relatedMatch  AML.T0053      mitre-atlas  semapv:ManualMappingCuration
AP-T2-07  asago-scenario-generator  skos:relatedMatch  AML.T0083      mitre-atlas  semapv:ManualMappingCuration
AP-T2-07  asago-scenario-generator  skos:relatedMatch  AML.T0086      mitre-atlas  semapv:ManualMappingCuration
```
