# Asago Scenario Generator Attack Pattern Format Analysis

Exhaustive analysis of how the AP-* attack pattern format is defined, loaded,
mapped, and consumed by the asago-scenario-generator pipeline. Every field, every
...
```yaml
source:
  name: "asago-scenario-generator abstract attack patterns"
  version: "0.1.0"
  derived_from:
...
| `subject_source` | Always `asago-scenario-generator` |
...
Loaded by:
- `load_attack_pattern_provenance()` in `src/asago_scenario_generator/data/loaders.py:216-244`
  - When no path given, globs all `attack-patterns*.sssom.tsv` files and concatenates
- `build_pattern_provenance_index()` in `src/asago_scenario_generator/data/loaders.py:247-274`
  - Builds `{pattern_id: {source: [object_ids]}}` nested index

Used by:
- `expand_seeds()` in `src/asago_scenario_generator/pipeline/seeds.py:141-144`
...
In `src/asago_scenario_generator/pipeline/threats.py`:
...
**File:** `src/asago_scenario_generator/data/loaders.py`
...
**File:** `src/asago_scenario_generator/data/threat_gating.py`
...
**File:** `src/asago_scenario_generator/pipeline/threats.py`
...
**File:** `src/asago_scenario_generator/pipeline/seeds.py`
...
**File:** `src/asago_scenario_generator/pipeline/candidates.py`
...
**File:** `src/asago_scenario_generator/pipeline/generate/assembly.py`
...
**File:** `src/asago_scenario_generator/pipeline/generate/assembly.py`, line 237-247
...
**File:** `src/asago_scenario_generator/pipeline/validation.py`
