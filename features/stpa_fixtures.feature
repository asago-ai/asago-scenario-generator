Feature: STPA fixture validation
  Every fixture YAML file in src/asago_scenario_generator/stpa/fixtures/ must load
  ...
  Background:
    Given the STPA fixtures directory exists at src/asago_scenario_generator/stpa/fixtures
