...
from asago_scenario_generator.models.attack_tree import AiSystemAction, ToolInvocationAction
...
class TestHITLFailureMechanism:
    ...
    def test_system_prompt_contains_hitl_failure_mechanism(self):
        prompt = render_prompt("call1_system.j2", **_CALL1_SYS_DEFAULTS)
    ...
    def test_system_prompt_mentions_specific_failure_examples(self):
        ...
        prompt_lower = render_prompt("call1_system.j2", **_CALL1_SYS_DEFAULTS).lower()
...
def _make_attack_tree(*, depth: int = 3, node_count: int = 5, exposures=None):
    ...
    from asago_scenario_generator.pipeline.generate import _tree_node_count
