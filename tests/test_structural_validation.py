...
from asago_scenario_generator.pipeline.validation import validate_scenario_structure
...
class TestStructuralValidation:
    ...
    def test_schema_loads_without_error(self):
        ...
        from asago_scenario_generator.pipeline.validation import _load_envelope_schema
