...
def _requirements_digest(requirements: list[dict[str, Any]]) -> str:
    payload = b"asago-scenario-generator:execution-requirements:v1\0" + json.dumps(
        requirements,
        sort_keys=True,
        separators=(",", ":"),
        ensure_ascii=False,
...
class TestPersistenceAndReporting:
    ...
    def test_report_block_distinguishes_capability_and_complexity(self) -> None:
        from asago_scenario_generator.report.template import _build_complexity_assessment_block
