"""Centralized logging configuration for asago-scenario-generator."""
...
_LOGGER_NAME = "asago_scenario_generator"
...
def setup_logging(
    ...
    """Configure the ``asago_scenario_generator`` logger hierarchy.
